...
The HPC environment became available to MCW researchers in March 2021. The cluster consists of **71** compute nodes, **3,400** CPU cores, and **40** GPUs. All cluster systems run on the Rocky Linux 8 operating system. The cluster is connected by **7** 100Gbps switches running a RoCEv2 network. Additionally, a **215TB** NVMe provides scratch storage, and a **1.77PB** scale-out NAS provides persistent storage.
